...
enum MeetingTriggerAction: Sendable, Equatable { case prompt, autoStart, ignore }
...
enum MeetingLinkDetector {
    ...
    static func videoMeetingURL(urlField: String?, notes: String?, location: String?) -> URL? {
...
enum MeetingTriggerLogic {
    static func decide(now: Date, start: Date, end: Date, leadSeconds: TimeInterval,
...
final class CalendarMonitor {
    ...
    init(leadSeconds: @escaping () -> TimeInterval,
