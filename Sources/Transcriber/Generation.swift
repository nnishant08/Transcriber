...
enum GenerationGroup: String, CaseIterable, Sendable {
...
struct GenerationTemplate: Identifiable, Hashable, Sendable {
    let id: String
    let name: String
...
struct GenerationOutput: Sendable {
    var text: String            // human-readable rendering (display / copy / share / export)
    var format: String          // "text" or "json"
    var json: String?           // structured JSON (flashcards / quiz) for CSV / Markdown export
}
...
enum GenerationStudio {
    ...
    static let builtins: [GenerationTemplate] = [
    ...
    static func allTemplates(customModes: [CustomSummaryMode]) -> [GenerationTemplate] {
    ...
    static func template(id: String, customModes: [CustomSummaryMode] = []) -> GenerationTemplate? {
    ...
    static func flashcardsCSV(fromJSON json: String) -> String? {
    ...
    static func quizCSV(fromJSON json: String) -> String? {
    ...
    static func displayText(_ art: GeneratedArtifact) -> String {
