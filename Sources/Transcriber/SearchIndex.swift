...
struct SessionHit: Sendable, Identifiable {
    let dir: URL
...
final class SearchIndex: @unchecked Sendable {
    static let shared = SearchIndex(cacheURL: SearchIndex.defaultCacheURL)
    ...
    func rebuildFromDisk(root: URL = SessionStore.root) {
    ...
    func search(_ query: String) -> [SessionHit] {
