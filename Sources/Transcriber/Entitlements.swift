...
enum PaidFeature: Hashable, Sendable {
...
struct LocalEntitlementProvider: EntitlementProvider {
    func isEntitled(_ feature: PaidFeature) -> Bool { true }
}
...
enum Entitlements {
    ...
    static func isEntitled(_ feature: PaidFeature) -> Bool { current.isEntitled(feature) }
}
