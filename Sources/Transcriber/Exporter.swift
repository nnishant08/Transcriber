...
enum Exporter {
    ...
    @discardableResult
    static func exportHTML(sessionDir: URL, to output: URL) throws -> URL {
    ...
    static func plainText(for sessionDir: URL) -> String {
    ...
    @discardableResult
    static func exportTXT(sessionDir: URL, to output: URL) throws -> URL {
    ...
    @discardableResult
    static func exportRTF(sessionDir: URL, to output: URL) throws -> URL {
    ...
    @MainActor
    @discardableResult
    static func exportPDF(sessionDir: URL, to output: URL) async throws -> URL {
        guard let html = htmlString(for: sessionDir) else { throw ExportError.noSession }
    ...
    private static func renderPDF(html: String) async throws -> Data {
        let webView = WKWebView(frame: NSRect(x: 0, y: 0, width: 820, height: 1000))
