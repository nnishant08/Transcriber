...
public enum SummaryStyle: String, CaseIterable, Codable, Identifiable, Sendable {
...
public enum Intelligence {
    ...
    public static func summarize(transcript: String, style: SummaryStyle) async throws -> String {
    ...
    public static func summarizeCustom(transcript: String, mode: CustomSummaryMode) async throws -> String {
        let text = transcript.trimmingCharacters(in: .whitespacesAndNewlines)
        guard !text.isEmpty else { throw SummaryError.emptyTranscript }
    ...
    public static func actionItems(transcript: String) async -> [String] {
        let text = transcript.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    public static func chapters(timestamped: String) async -> [Chapter] {
    ...
    public static func secondsFromTimestamp(_ ts: String) -> TimeInterval {
    ...
    public static func run(instructions: String, prompt: String, temperature: Double = 0.3, maxTokens: Int? = nil) async throws -> String {
        #if canImport(FoundationModels)
