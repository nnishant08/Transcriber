...
public enum Importer {
    ...
    public struct Config: Sendable {
        ...
        public var language: String?              // explicit ISO code, or nil when auto-detecting
        public var autoDetectLanguage: Bool = false   // "Auto" setting: detect once on a lead-in, then pin
    ...
    public static func isSupported(_ url: URL) -> Bool { AudioFileIO.isSupported(url) }
    ...
    public static func run(url: URL, config: Config, root: URL = SessionLocation.root,
