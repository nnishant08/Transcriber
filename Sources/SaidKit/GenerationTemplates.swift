...
//
// All gated `@available(macOS 26.0, iOS 26.0, *)` because `@Generable` conforms the type to
...
@available(macOS 26.0, iOS 26.0, *)
enum StructuredGen {
    public static func run(kind: GenerationKind, transcript: String, grounding: String) async throws -> GenerationOutput {
        switch kind {
        case .minutes:
