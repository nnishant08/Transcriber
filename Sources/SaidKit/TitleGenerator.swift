...
public enum TitleGenerator {
    public struct Result: Sendable { public let title: String; public let tags: [String] }

    /// Deterministic, model-free title: the first meaningful words of the transcript, else the date.
    public static func fallbackTitle(transcript: String, date: Date) -> String {
    ...
    public static func generate(transcript: String, date: Date) async -> Result {
    ...
    public static func sanitizeTitle(_ s: String) -> String {
